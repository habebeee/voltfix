...
$catColor = ['KULKAS'=>['bg'=>'#EFF6FF','border'=>'#BFDBFE','text'=>'#1D4ED8'], 'TV'=>['bg'=>'#F5F3FF','border'=>'#DDD6FE','text'=>'#6D28D9'], 'MESIN_CUCI'=>['bg'=>'#ECFDF5','border'=>'#A7F3D0','text'=>'#065F46']][$ticket->category] ?? ['bg'=>'#F9FAFB','border'=>'#E5E7EB','text'=>'#374151'];
@endphp
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">
                                {{ ['KULKAS'=>'Spesialis Kulkas','TV'=>'Spesialis TV','MESIN_CUCI'=>'Spesialis Mesin Cuci'][$ticket->technician->skill_category] ?? $ticket->technician->skill_category }}
                            </p>
                        </div>
                    </div>
