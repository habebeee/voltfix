...
<div class="space-y-6 max-w-5xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <a href="{{ route('customer.tickets.create') }}"
           class="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white text-sm font-semibold px-5 py-2.5 rounded-xl shadow-lg shadow-orange-200 hover:shadow-orange-300 transition-all self-start sm:self-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div>
                <div class="text-stat text-3xl text-gray-900 leading-none mb-0.5">{{ $card['value'] }}</div>
    ...
    <div class="relative overflow-hidden rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-5"
        ...
        <div class="relative">
            <p class="text-white font-extrabold text-lg leading-tight">Butuh servis elektronik?</p>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        @if($tickets->isEmpty())
            ...
            <div class="flex flex-col items-center justify-center py-16 px-6 text-center">
                ...
                <a href="{{ route('customer.tickets.create') }}"
                   class="inline-flex items-center gap-1.5 bg-gradient-to-r from-orange-500 to-amber-500 text-white text-xs font-semibold px-4 py-2 rounded-lg shadow-md shadow-orange-200 hover:shadow-orange-300 transition-all">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4v16m8-8H4"/>
                    </svg>
                    Ajukan Sekarang
