...
<head>
    ...
    <title>Lupa Password — VoltFix</title>
...
<body class="min-h-screen flex flex-col">
    <header class="sticky top-0 z-20">
        <div class="relative overflow-hidden border-b border-orange-200/60 bg-gradient-to-r from-orange-500 via-amber-500 to-orange-400 shadow-lg shadow-orange-500/20">
            ...
            <div class="relative max-w-md mx-auto px-3 sm:px-4 py-2.5 flex items-center">
                <a href="{{ route('home') }}"
                   class="group inline-flex items-center gap-2.5 rounded-full bg-white/15 hover:bg-white/25 border border-white/30 backdrop-blur-sm pl-1.5 pr-3.5 py-1.5 transition-all duration-200 hover:-translate-x-0.5">
                    <span class="w-8 h-8 rounded-full bg-white text-orange-600 flex items-center justify-center shadow-md">
    ...
    <div class="flex-1 flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl border border-orange-100 shadow-xl shadow-orange-100/50 p-8">
                ...
                <h1 class="text-2xl font-extrabold text-slate-900 text-center mb-1">Lupa password?</h1>
                <p class="text-sm text-slate-500 text-center mb-6">Masukkan email terverifikasi Anda. Kami kirim link untuk membuat password baru.</p>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-4">
                    @csrf
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">Email terverifikasi</label>
                ...
                <div class="mt-6 pt-6 border-t border-orange-50 text-center">
                    <a href="{{ route('login') }}" class="text-sm text-orange-600 hover:text-orange-700 font-semibold">
