...
<head>
    ...
    <style>
        ...
        body {
            ...
            background:
                radial-gradient(ellipse 60% 50% at 80% 20%, rgba(251,146,60,.15) 0%, transparent 55%),
    ...
    <div class="flex-1 flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl border border-orange-100 shadow-xl shadow-orange-100/50 p-8">
                ...
                <h1 class="text-2xl font-extrabold text-slate-900 text-center mb-1">Buat akun baru</h1>
                <p class="text-sm text-slate-500 text-center mb-6">Daftar sebagai pelanggan untuk ajukan servis</p>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-1">Format internasional, contoh: 6281234567890</p>
                    </div>
                ...
                <div class="mt-6 pt-6 border-t border-orange-50 text-center">
                    <p class="text-sm text-slate-500">Sudah punya akun?
                        <a href="{{ route('login') }}" class="text-orange-600 hover:text-orange-700 font-semibold">Masuk di sini</a>
                    </p>
                </div>
            </div>
