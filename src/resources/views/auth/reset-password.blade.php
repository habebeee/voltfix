...
<head>
    ...
    <title>Buat Password Baru — VoltFix</title>
                ...
                <a href="{{ route('login') }}"
                   class="group inline-flex items-center gap-2.5 rounded-full bg-white/15 hover:bg-white/25 border border-white/30 backdrop-blur-sm pl-1.5 pr-3.5 py-1.5 transition-all duration-200 hover:-translate-x-0.5">
                    ...
                    <span class="leading-tight">
                        ...
                        <span class="block text-sm font-bold text-white">Kembali ke masuk</span>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="flex-1 flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            <div class="bg-white rounded-2xl border border-orange-100 shadow-xl shadow-orange-100/50 p-8">
                ...
                <h1 class="text-2xl font-extrabold text-slate-900 text-center mb-1">Buat password baru</h1>
                <p class="text-sm text-slate-500 text-center mb-6">Masukkan password baru untuk akun VoltFix Anda.</p>
